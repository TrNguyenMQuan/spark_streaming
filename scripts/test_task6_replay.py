...
print(f"Target test file selected: {TEST_FILE}")
...
def main():
    ...
    try:
        ...
        print(f"  Result -> Nodes: {nodes_tc1} (Diff: +{nodes_tc1 - nodes_base})")
        ...
        print(f"  Result -> Nodes: {nodes_tc2} (Diff from TC1: +{nodes_tc2 - nodes_tc1})")
        ...
        print(f"  Result -> Nodes: {nodes_tc3} (Diff from TC2: {nodes_tc3 - nodes_tc2})")
        ...
        print(f"  Result -> Nodes: {nodes_tc4}, Edges: {edges_tc4}")
        ...
        print(f"  Result -> Nodes: {nodes_tc5}, Edges: {edges_tc5}")
